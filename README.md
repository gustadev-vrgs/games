...
- **Uno:** no seu turno, selecione uma carta compatível com a cor, número ou símbolo e confirme em **Jogar carta**. Para descartar várias de uma vez, clique em cartas numéricas com o mesmo número; clique novamente para remover. A interface mostra quantidade e ordem, e a última selecionada ficará no topo e definirá a cor ativa. A combinação inteira avança apenas um turno. Cartas especiais não podem ser combinadas. **Comprar carta** aparece na jogada normal e **Passar** após uma compra jogável; depois de comprar, a carta comprada só pode ser jogada sozinha. Ao confirmar um curinga, escolha vermelho, amarelo, verde ou azul na janela central; cancelar não envia nada. **Declarar Uno** é exigido quando a jogada deixará uma carta; zerar a mão vence sem penalidade.
