extends Node
enum AppPhase { BOOT, MAIN_MENU, HOST_SETUP, JOIN_SETUP, TRAINING_SETUP, CONNECTING, LOBBY, LOADING_MATCH, IN_MATCH, RESULTS, DISCONNECTING }
...
func reset_all() -> void: reset_match(); session_id = ""; game_id = ""; is_host = false; is_training = false; approved_config.clear(); players.clear(); app_phase = AppPhase.MAIN_MENU
